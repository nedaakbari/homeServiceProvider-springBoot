        ...
        <div class=" text-center" style="padding : 60px 300px 0px 300px">
            ...
            <div>
                ...
                <select name="sort" id="sort">
                    ...
                    <option value="proposedPrice">proposedPrice</option>
                </select>--%>
            </div>
            <table class="table table-bordered table-striped " style="font-size: 12px">
                ...
                <tr class="bg-dark text-light">
                    <th scope="col" >
                        <a href="<c:url value="/customer/seeAllOfferAnOrders/{proposedPrice}"/> ">proposedPrice</a>
                    </th>
                    <th scope="col">startWorkTime</th>
                    <th scope="col">duringTime</th>
                    <th scope="col">description</th>
                    <th scope="col"> expert: firstName</th>
                    <th scope="col"> expert: lastName</th>
                    <th scope="col">
                        <a href="<c:url value="/customer/seeAllOfferAnOrders/{expert.score}"/>">score</a>
                    </th>
                ...
                <c:forEach var="offer" items="${allOfferOfAnOrder}">
                    <tr>
                        ...
                        <td>${offer.expert.score}</td>
                        <td>
                            <a href="<c:url value="/customer/acceptOffer/${offer.codeNumber}"/> ">Accept</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
