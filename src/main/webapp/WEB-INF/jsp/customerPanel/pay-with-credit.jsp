    ...
    <div class="container" style="margin-top: 150px;margin-left: 500px">
        <c:choose>
            <c:when test="${error!=null}">
                ...
                <a href="<c:url value="/customer/editCredit"/>" class="btn btn-dark">charge credit</a>
            </c:when>
            <c:otherwise>
                <p class="text-success" style="text-color:red !important;">${message}</p>
                <a href="<c:url value="/customer/dashboard"/>" class="btn btn-dark">go to home panel</a>
            </c:otherwise>
        </c:choose>
