    ...
    <div class="cole-6">
        <div class=" text-center" style="padding : 60px 300px 0px 300px">
            <table class="table table-bordered table-striped text-info">
                ...
                <tr>
                    <th>Title</th>
                    <th> Delete from your speciality</th>
                    <th> subject</th>
                </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="btn-group mt-3 mx-3">
                                <a href="<c:url value="/expert/delete/${sub.title}"/>">DELETE</a>
                            </div>
                                <%-- <button type="button" onclick="javascript:window.location=registers.jsp">register</button>  --%>
                        </td>
                        <td>
                            <a href="<c:url value="/expert/orderListOf/${sub.title}"/>"> see orders </a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
